...
public class DepositFrame extends JFrame {
	public DepositFrame(UserBean user,MoneyBean balance) {
		setTitle("存款界面");
		setResizable(false);
		// 1、设置窗口位置在屏幕正中央
		int width = 350;
		...
		JLabel lb_1 = new JLabel("请输入存款金额：");
		JLabel lb_2 = new JLabel("");
		JTextField tf_1 = new JTextField();
		JButton bt_1 = new JButton("存入");
		...
		bt_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Boolean bool =new ManagerImpl().Deposit(user,balance,money);
				if (bool==true) {
					lb_2.setText("    存入成功       ");
					lb_2.setBounds(120, 160,90, 20);
				}else {
					lb_2.setBounds(110, 160, 120, 20);
					lb_2.setText("请存入正确的金额");
				}
			}
		});
